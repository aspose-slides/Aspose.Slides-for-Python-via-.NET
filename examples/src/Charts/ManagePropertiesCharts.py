...
def charts_manage_properties():
    ...
    with slides.Presentation() as presentation:
        ...
        chart = slide.shapes.add_chart(slides.charts.ChartType.STACKED_COLUMN3_D, 0, 0, 500, 500)
        ...
        presentation.save(outDir + "charts_manage_properties_out.pptx", slides.export.SaveFormat.PPTX)
