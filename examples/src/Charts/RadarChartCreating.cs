...
namespace Aspose.slides.Examples.CSharp.Charts
{
    public class RadarChartCreation
    {
        ...
        {
            outPath = Path.Combine(RunExamples.OutPath, "RadarChart_Out.pptx")
            ...
            with slides.Presentation() as pres:
            {
                ...
                series.data_points.AddDataPointForRadarSeries(fact.get_cell(defaultWorksheetIndex, 1, 1, 2.7))
                series.data_points.AddDataPointForRadarSeries(fact.get_cell(defaultWorksheetIndex, 2, 1, 2.4))
                series.data_points.AddDataPointForRadarSeries(fact.get_cell(defaultWorksheetIndex, 3, 1, 1.5))
                series.data_points.AddDataPointForRadarSeries(fact.get_cell(defaultWorksheetIndex, 4, 1, 3.5))
                series.data_points.AddDataPointForRadarSeries(fact.get_cell(defaultWorksheetIndex, 5, 1, 5))
                series.data_points.AddDataPointForRadarSeries(fact.get_cell(defaultWorksheetIndex, 6, 1, 3.5))
                ...
                series.data_points.AddDataPointForRadarSeries(fact.get_cell(defaultWorksheetIndex, 1, 2, 2.5))
                series.data_points.AddDataPointForRadarSeries(fact.get_cell(defaultWorksheetIndex, 2, 2, 2.4))
                series.data_points.AddDataPointForRadarSeries(fact.get_cell(defaultWorksheetIndex, 3, 2, 1.6))
                series.data_points.AddDataPointForRadarSeries(fact.get_cell(defaultWorksheetIndex, 4, 2, 3.5))
                series.data_points.AddDataPointForRadarSeries(fact.get_cell(defaultWorksheetIndex, 5, 2, 4))
                series.data_points.AddDataPointForRadarSeries(fact.get_cell(defaultWorksheetIndex, 6, 2, 3.6))
                ...
                txtCat.fill_format.solid_fill_color.color = Color.DimGray
                ...
                txtleg.fill_format.solid_fill_color.color = Color.DimGray
                txtCat.latin_font = slides.FontData("Calibri")
                ...
                txtVal.fill_format.solid_fill_color.color = Color.DimGray
                ...
                ichart.axes.vertical_axis.major_unit = 1.25f

                # Save generated presentation
                pres.save(outPath, slides.export.SaveFormat.PPTX)
            }
        }
    }
}