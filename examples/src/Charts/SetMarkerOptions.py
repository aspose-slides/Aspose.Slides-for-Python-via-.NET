...
def charts_set_marker_options():
    ...
    with slides.Presentation() as presentation:
        ...
        # Set the picture
        image1 = drawing.Bitmap(dataDir + "image1.jpg")
        imgx1 = presentation.images.add_image(image1)

        # Set the picture
        image2 = drawing.Bitmap(dataDir + "image2.jpg")
        ...
        presentation.save(outDir + "charts_set_marker_options_out.pptx", slides.export.SaveFormat.PPTX)
