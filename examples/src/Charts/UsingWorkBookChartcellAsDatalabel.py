...
def charts_workbook_as_datalabel():
    ...
    with slides.Presentation(dataDir + "charts_workbook_as_datalabel.pptx") as pres:
        ...
        pres.save(outDir + "charts_workbook_as_datalabel_out.pptx", slides.export.SaveFormat.PPTX)
