...
def charts_set_invert_fill_color_chart():
    #ExStart:SetInvertFillColorChart
    # The path to the documents directory.
    outDir = "./examples/out/"
    inverColor = drawing.Color.red
    with slides.Presentation() as pres:
        ...
        series.inverted_solid_fill_color.color = inverColor
        pres.save(outDir + "charts_set_invert_fill_color_chart_out.pptx", slides.export.SaveFormat.PPTX)               
