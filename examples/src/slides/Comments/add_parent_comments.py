...
def add_parent_comments(global_opts):
    with slides.Presentation() as pres:
        ...
        # Add reply to reply
        sub_reply = author1.comments.add_comment("subreply 3 for reply 2", pres.slides[0], drawing.PointF(10, 10), date.today())
        ...
        pres.save(global_opts.out_dir + "comments_parent_comment_out.pptx", slides.export.SaveFormat.PPTX)

        # Remove comment1 and all its replies
        comment1.remove()

        pres.save(global_opts.out_dir + "comments_remove_comment_out.pptx", slides.export.SaveFormat.PPTX)
