...
namespace Aspose.slides.Examples.CSharp.Tables
{
    public class AddImageinsideTableCells                                                                            
    {
        public static void Run()
        {
            ...
            tbl[0, 0].CellFormat.FillFormat.picture_fill_format.CropLeft = 20
            tbl[0, 0].CellFormat.FillFormat.picture_fill_format.CropTop = 20
            tbl[0, 0].CellFormat.FillFormat.picture_fill_format.CropBottom = 20
            # Save PPTX to Disk
