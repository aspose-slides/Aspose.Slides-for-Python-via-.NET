...
def export_math_paragraph_to_latex():
    ...
    with slides.Presentation() as pres:
        ...
        # Add a formula.
        math_paragraph.add(math.MathematicalText("a").set_superscript("2").join("+").join(
            math.MathematicalText("b").set_superscript("2")).join("=").join(math.MathematicalText("c").set_superscript("2")))
