...
def charts_get_values_and_unit_scale_from_axis(global_opts):
    with slides.Presentation() as pres:
        ...
        # Saving presentation
        pres.save(global_opts.out_dir + "charts_get_values_and_unit_scale_from_axis_out.pptx", slides.export.SaveFormat.PPTX)
