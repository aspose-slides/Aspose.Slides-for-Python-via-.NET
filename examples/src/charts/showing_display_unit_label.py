...
def charts_showing_display_unit_label(global_opts):
	with slides.Presentation() as pres:
		...
		pres.save(global_opts.out_dir + "charts_showing_display_unit_label_out.pptx", slides.export.SaveFormat.PPTX)
