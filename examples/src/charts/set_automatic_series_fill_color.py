...
def charts_set_automatic_series_fill_color(global_opts):
    with slides.Presentation() as presentation:
        ...
        presentation.save(global_opts.out_dir + "charts_set_automatic_series_fill_color_out.pptx", slides.export.SaveFormat.PPTX)
