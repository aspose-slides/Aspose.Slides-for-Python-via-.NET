...
def charts_chart_area_rounded_borders(global_opts):
	with slides.Presentation() as presentation:
		...
		presentation.save(global_opts.out_dir + "charts_chart_area_rounded_borders_out.pptx", slides.export.SaveFormat.PPTX)
