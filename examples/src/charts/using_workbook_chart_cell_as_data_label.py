...
def charts_workbook_as_datalabel(options):
    lbl0 = "Label 0 cell value"
    lbl1 = "Label 1 cell value"
    lbl2 = "Label 2 cell value"

    # Instantiate Presentation class that represents a presentation file
    with slides.Presentation(options.data_dir + "charts_workbook_as_datalabel.pptx") as pres:
        ...
        pres.save(options.out_dir + "charts_workbook_as_datalabel_out.pptx", slides.export.SaveFormat.PPTX)
